...
REGRESSION_CASE_MODULES = [
    ...
    "regression_cases.test_object_frame_default",
]
...
KNOWN_ISSUE_CASES: dict[str, str] = {
    ...
    "context_get_tabs_as_id": "ChromiumContext.get_tabs(as_id=True) runtime support is not merged yet.",
    "locator_explicit_syntax": "Explicit locator syntax currently falls back to text search before the locator fix is merged.",
    "object_frame_default": "get_frames() default does not include object until the object-frame fix is merged.",
}
